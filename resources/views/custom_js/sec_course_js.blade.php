<script>
    ...
    $('#processed-table').DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": "/sec-sdg-course-processed/data",
            "type": "GET",
        },
        "columns": [
            { "data": "id", "width": "10%" , "orderable": false },
...
function viewModal(row_id) {
    ...
    ({
    type:"GET",
    url:"/sec-sdg-course-view/" + row_id,
...
function viewModal2(row_id) {
    ...
    ({
    type:"GET",
    url:"/sec-sdg-course-view-processed/" + row_id,
    success:function(response)
        { 
...
function approve() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                type: "PUT", 
                url: "/sec-sdg-course-approve/"+id+"/"+approved_sdg , 
                headers: {
