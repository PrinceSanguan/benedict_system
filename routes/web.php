...
Route::middleware('auth:sanctum')->group(function () { 
    ...
    Route::namespace('CarbonFootprint')->group(function () {
        ...
        Route::get('/carbon-footprint/getCarbonData', [CarbonFootprintController::class, 'getCarbonData']);
        Route::get('/carbon-footprint-all/getCarbonDataAll/{table?}', [CarbonFootprintController::class, 'getCarbonDataAll']);
        ...
        Route::post('/carbon-footprint/add-water', [CarbonFootprintController::class, 'addWater'])->name('add-water');
        Route::post('/carbon-footprint/add-solid-waste', [CarbonFootprintController::class, 'addSolidWaste'])->name('add-solid-waste');
        Route::post('/carbon-footprint/add-electricity', [CarbonFootprintController::class, 'addElectricity'])->name('add-electricity');
        Route::post('/carbon-footprint/add-fuel', [CarbonFootprintController::class, 'addFuel'])->name('add-fuel');
    });
    ...
    Route::namespace('Analytic')->group(function () {
        ...
        Route::get('/carbon', [AnalyticController::class, 'carbon_index'])->name('carbon');
    });
